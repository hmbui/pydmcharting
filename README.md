...
The TimeChart (formerly PyDMCharting) project is now a part of the SLAC Lab home. It will be maintained and open for contributions at [the new TimeChart repo](https://github.com/slaclab/timechart "SLAC Lab TimeChart"). The rest of the TimeChart repo here is an archive.
